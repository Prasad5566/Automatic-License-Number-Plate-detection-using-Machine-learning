...
class LicensePlateApp:
    def __init__(self, root):
        ...
        self.bg_image = Image.open("background3.jpg")  # Replace with the path to your background image
        ...
        self.bg_label.place(x=0, y=0, relwidth=1, relheight=1)  # Fill the entire window with the image

        # Title Label
        self.lblTitle = tk.Label(root, text="Automatic License Plate Number Detection System", font=("Comic Sans MS", 24, "bold"), bg="#3E4A89", fg="white")
        ...
        self.btnBrowse = tk.Button(self.button_frame, text="Browse Image", command=self.browse_image,
                                   bg="#4CAF50", fg="white", font=("Comic Sans MS", 12, "bold"), padx=20, pady=10)
        ...
        self.btnWebcam = tk.Button(self.button_frame, text="Capture from Webcam", command=self.capture_from_webcam,
                                   bg="#008CBA", fg="white", font=("Comic Sans MS", 12, "bold"), padx=20, pady=10)
        ...
        self.btnVideo = tk.Button(self.button_frame, text="Process Video", command=self.process_video,
                                  bg="#FF5733", fg="white", font=("Comic Sans MS", 12, "bold"), padx=20, pady=10)
        self.btnVideo.grid(row=0, column=2, padx=10)

        # About Button
        self.btnAbout = tk.Button(self.button_frame, text="About", command=self.show_about,
                                  bg="#FFD700", fg="black", font=("Comic Sans MS", 12, "bold"), padx=20, pady=10)
        ...
        # Result Label
        self.lblResult = tk.Label(root, text="", font=("Comic Sans MS", 14,"bold"), bg="#3E4A89", fg="white")
    ...
    def display_result(self, license_plate, vehicle_info):
        ...
        bold_font = tkFont.Font(family="Comic Sans MS", size=14, weight="bold")
    ...
    # Create a new Toplevel window
        ...
        lblAboutTitle = tk.Label(self.about_frame, text="About Automatic Number Plate Recognition (ANPR) System", font=("Comic Sans MS", 18, "bold"), bg="#3E4A89", fg="white")
        ...
        lblAboutText = tk.Label(self.about_frame, text=about_text, font=("Comic Sans MS", 14), bg="#3E4A89", fg="white", wraplength=600, justify="left")
